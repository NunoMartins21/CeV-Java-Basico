...
public class TelaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 130, 70));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 40, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 90, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        // Génio
        int rand = (int) (1 + Math.random() * (6-1));
        // Palpite
        int num = (int) txtVal.getValue();
        // Falas do Génio
        String f1 = "<html><strong>ACERTOU!</strong></html>";
        String f2 = "<html><strong>ERROU!</strong> Eu pensei no valor <strong>" + rand + "</strong></html>";
        // Resultado
        String res = (num == rand) ? f1 : f2;
